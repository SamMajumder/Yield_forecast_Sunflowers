...
packages <- list("here","tidyverse","tidyUSDA",
                 "ggplot2","gganimate","sf")
...
# Check if "RawDatasets","ProcessedDatasets",
## "Figures", "SavedModels", "RDSObjects",
## "Shapefiles",folder exists, if not, create it

# List of directories to create
dirs_to_create <- c("RawDatasets", "ProcessedDatasets","Figures","SavedModels",
                    "RDSObjects","Shapefiles")
