...
Combined_model <- readRDS(here::here("Models","XGB_combined_model_yield.rds"))
...
#######
## Adding all the predictions in one dataframe ###
######### 
...
Train_test_errors_sf <- rbind(ND_SD_predictions,MN_predictions,CO_predictions,
                           KS_predictions,NE_predictions,TX_predictions) 
...
Average_test_errors <- Train_test_errors_sf %>% 
                                      st_drop_geometry() %>% 
                                      filter(Dataset == "Test") %>%
...
### Adding the FIPS values to average error file ### 

Average_test_errors <- inner_join(Average_test_errors,FIPS_test)
...
write.csv(Average_test_errors,
          "C:/Users/samba/Documents/Yield_forecast_Sunflowers/Yield_forecast_Sunflowers/Processed_Datasets/Average_errors.csv",
          row.names = F)
...
saveRDS(Average_test_errors,
        "C:/Users/samba/Documents/Yield_forecast_Sunflowers/Yield_forecast_Sunflowers/RDS_objects/Average_errors.RDS")
