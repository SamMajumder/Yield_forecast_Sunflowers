...
Drought_data_latest <-  read_csv(here::here("Processed_Datasets",
                                            "Drought_data_latest.csv"))
...
#### Filtering out the Drought data ### for MN

Drought_data_latest_MN <- Drought_data_latest %>% 
                                             filter(State == "MN")
...
Future_predictions_MN <- Future_predictions_all_timeframes(Future_State_data_2040_126=Future_Data_2040_126_MN,
                                                        ...
                                                        Drought_data=Drought_data_latest_MN,
...
#### Filtering out the Drought data ### for CO

Drought_data_latest_CO <- Drought_data_latest %>% 
                                         filter(State == "CO")
...
Future_predictions_CO <- Future_predictions_all_timeframes(Future_State_data_2040_126=Future_Data_2040_126_CO,
                                                           ...
                                                           Drought_data=Drought_data_latest_CO,
...
NE_model <- readRDS(here::here("Models","XGB_NE_model.rds"))
...
#### Filtering out the Drought data ### for NE

Drought_data_latest_NE <- Drought_data_latest %>% 
  filter(State == "NE")
...
Future_predictions_NE <- Future_predictions_all_timeframes(Future_State_data_2040_126=Future_Data_2040_126_NE,
                                                           ...
                                                           Drought_data=Drought_data_latest_NE,
...
#### Filtering out the Drought data ### for KS

Drought_data_latest_KS <- Drought_data_latest %>% 
  filter(State == "KS")
...
Future_predictions_KS <- Future_predictions_all_timeframes(Future_State_data_2040_126=Future_Data_2040_126_KS,
                                                           ...
                                                           Drought_data=Drought_data_latest_KS,
...
Drought_data_latest_TX <- Drought_data_latest %>% 
  filter(State == "TX")
...
Future_predictions_TX <- Future_predictions_all_timeframes(Future_State_data_2040_126=Future_Data_2040_126_TX,
                                                           ...
                                                           Drought_data=Drought_data_latest_TX,
...
Future_predictions <- Future_predictions_all_timeframes(Future_State_data_2040_126=Future_Data_2040_126,
                                                        ...
                                                        Drought_data=Drought_data_latest,
