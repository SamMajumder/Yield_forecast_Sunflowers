---
title: "Future Climate Data Cleaning"
output: html_notebook
---

**Loading the packages and sourcing some custom functions** 
...
The following code will clean data between 2021-2040 
...
**Exporting the datasets** (to the **Processed_Datasets** folder)

```{r}


write.csv(RCP_126,
          "path to datasets/Future_Data_2040_126.csv",
          row.names=F)


write.csv(RCP_245,
          "path to datasets/Future_Data_2040_245.csv",
          row.names=F) 


write.csv(RCP_370,
          "path to datasets/Future_Data_2040_370.csv",
          row.names=F)

write.csv(RCP_585,
          "path to datasets/Future_Data_2040_585.csv",
          row.names=F)

```

The following code will clean data between 2041-2060 
...
write.csv(RCP_126,
          "path to datasets/Future_Data_2060_126.csv",
          row.names=F)


write.csv(RCP_245,
          "path to datasets/Future_Data_2060_245.csv",
          row.names=F) 


write.csv(RCP_370,
          "path to datasets/Future_Data_2060_370.csv",
          row.names=F)

write.csv(RCP_585,
          "path to datasets/Future_Data_2060_585.csv",
          row.names=F)

```

The following code will clean data between 2061-2080
...
write.csv(RCP_126,
          "path to datasets/Future_Data_2080_126.csv",
          row.names=F)


write.csv(RCP_245,
          "path to datasets/Future_Data_2080_245.csv",
          row.names=F) 


write.csv(RCP_370,
          "path to datasets/Future_Data_2080_370.csv",
          row.names=F)

write.csv(RCP_585,
          "path to datasets/Future_Data_2080_585.csv",
          row.names=F)
