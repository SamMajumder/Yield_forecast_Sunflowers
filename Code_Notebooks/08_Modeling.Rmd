...
1) Use Recursive Feature Elimination to ascertain the most important variables
in each training dataset (both at the national level and at the state level)
2) Train predictive models using Random Forest, Gradient Boosting Machines and 
xgBoost using the most important variables as deemed by the first step

The national training and test datasets contain data from all seven states and 
the state level datasets contain data from a particular state.  

**PS: You will find the saved models in the folder Models as RDS objects**

**PPS: Please edit the input or output file paths throughout this script based on your project organization** 
...
**Exporting the resulting dataframes to the Processed_Datasets folder** (Path to output folder may differ for you)
...
**Now modeling using Random Forest, Gradient Boosting and xgBoost using only 
the most important factors** 

Please edit the input or output paths as per your project organisation
...
**RECURSIVE FEATURE ELIMINATION** (North Dakota)
