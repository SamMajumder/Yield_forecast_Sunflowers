---
title: "Variable importance computation on test datasets and plotting them on both training and test"
output: html_notebook
---

## NATIONAL LEVEL TEST DATASET ##

**PS: Please update the path of the input and output folders based on your project organisation**
...
**Creating the variable importance plots**
...
**Exporting the dataframe as an RDS object** 

```{r}
#### Exporting the dataset as an rds object

### first getting the path 
here("RDS_objects")
